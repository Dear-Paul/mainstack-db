...
interface LinkInBioIconProps extends SVGProps<SVGSVGElement> {
  isColored?: boolean;
}

export default function LinkInBioIcon({
  isColored = false,
  ...props
}: LinkInBioIconProps) {
  return (
    ...
    >
      <path
        ...
        stroke={isColored ? 'url(#paint0_linear_12253_597)' : '#D3D3D3'}
        strokeWidth="2.7"
        strokeMiterlimit="10"
      />
      <path
        ...
        stroke={isColored ? 'url(#paint1_linear_12253_597)' : '#D3D3D3'}
        strokeWidth="2.7"
        strokeMiterlimit="10"
      />
      <path
        ...
        fill={isColored ? 'url(#paint2_linear_12253_597)' : '#D3D3D3'}
      />
      {isColored && (
        <defs>
          <linearGradient
            id="paint0_linear_12253_597"
            x1="2.89831"
            y1="8.44539"
            x2="18.1056"
            y2="8.44539"
